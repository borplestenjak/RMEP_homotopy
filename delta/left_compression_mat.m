function RWS = left_compression_mat(m,k)

%LEFT_COMPRESSION_MAT  Left compression matrix for rectangular MEP
%
% RWS = LEFT_COMPRESSION_MAT(m,k) returns left compression matrix T 
