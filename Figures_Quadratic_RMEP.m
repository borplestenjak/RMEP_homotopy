...
R = readmatrix("Comparison_polynomial_RMEP.xlsx","Sheet","All data");
...
rows_quad = find(R(:,1)==2);
R = R(rows_quad,2:end); % submatrix with data for quadratic RMEPs
