function [points,val,err,cand,simple] = lti2_homotopy(y,opts)

%LTI2_HOMOTOPY returns stationary points for the LTI(2) model
%
% [points, val, err, cand] = lti2_homotopy(y,opts) returns real stationary points
...
% and solve RMEP by the homotopy method
...
if ~isfield(opts,'maxruns'),     opts.maxruns = 2;         end 
...
% of the quadratic rectangular MEP 
